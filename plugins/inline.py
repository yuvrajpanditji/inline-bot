...
async def answer(bot, query):
    ...
    if results:
        ...
        switch_pm_text = f'{emoji.CROSS_MARK}No  files   Found in This name 🙁 You can still request for it to Pandit Ji'
        if string:
            switch_pm_text += f' for "{string}"'
...
def get_reply_markup(username, query):
    ...
    buttons = [
        ...
        [
           ...
           InlineKeyboardButton('Join SMP Novels Fans! ', url='https://t.me/smpnovelsfans'),
        ],
    ]
